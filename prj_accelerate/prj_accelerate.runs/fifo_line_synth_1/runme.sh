...
HD_PWD='E:/WorkSpace/project/prj_ocr/prj_ocr/prj_ocr.runs/fifo_line_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_line.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_line.tcl
