...
HD_PWD='E:/WorkSpace/project/prj_ocr/prj_ocr/prj_ocr.runs/gray_count_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray_count_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray_count_bram.tcl
