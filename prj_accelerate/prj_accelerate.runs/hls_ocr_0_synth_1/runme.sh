...
HD_PWD='E:/WorkSpace/project/prj_ocr/prj_ocr/prj_ocr.runs/hls_ocr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hls_ocr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hls_ocr_0.tcl
