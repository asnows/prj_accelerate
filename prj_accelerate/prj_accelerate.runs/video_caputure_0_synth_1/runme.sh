...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/video_caputure_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_caputure_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_caputure_0.tcl
