...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/design_1_algorithm_accelerate_1_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_algorithm_accelerate_1_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_algorithm_accelerate_1_4.tcl
