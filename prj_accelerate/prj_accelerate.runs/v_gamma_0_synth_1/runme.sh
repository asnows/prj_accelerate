...
HD_PWD='E:/WorkSpace/project/FPGA/prj_sc030_V2.0_emmc/prj_sc030/prj_sc030.runs/v_gamma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_gamma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_gamma_0.tcl
