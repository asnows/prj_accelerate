...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/sobel_filter_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_filter_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobel_filter_3.tcl
