...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/design_1_video_caputure_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_video_caputure_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_video_caputure_0_2.tcl
