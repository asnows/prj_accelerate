...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/design_1_pipe_sel_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pipe_sel_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pipe_sel_0_1.tcl
