...
HD_PWD='E:/WorkSpace/project/prj_ocr_axi/prj_ocr/prj_ocr.runs/sobel_filter_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sobel_filter_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sobel_filter_2.tcl
