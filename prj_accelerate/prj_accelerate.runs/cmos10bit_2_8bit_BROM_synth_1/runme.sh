...
HD_PWD='E:/WorkSpace/project/prj_ocr/prj_ocr/prj_ocr.runs/cmos10bit_2_8bit_BROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmos10bit_2_8bit_BROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmos10bit_2_8bit_BROM.tcl
