...
HD_PWD='E:/WorkSpace/project/FPGA/prj_accelerate/prj_accelerate/prj_accelerate.runs/img_cpy_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_cpy_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_cpy_0.tcl
