...
(* CORE_GENERATION_INFO="img_get_grads,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.171000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=3,HLS_SYN_DSP=1,HLS_SYN_FF=1014,HLS_SYN_LUT=1874}" *)

module img_get_grads (
        video_in_TDATA,
        video_in_TKEEP,
        video_in_TSTRB,
        video_in_TUSER,
...
wire    get_grads_opr_U0_ap_start;
wire    get_grads_opr_U0_ap_done;
wire    get_grads_opr_U0_ap_continue;
wire    get_grads_opr_U0_ap_idle;
wire    get_grads_opr_U0_ap_ready;
wire    get_grads_opr_U0_start_out;
wire    get_grads_opr_U0_start_write;
wire    get_grads_opr_U0_srcImg_rows_V_read;
wire    get_grads_opr_U0_srcImg_cols_V_read;
wire    get_grads_opr_U0_srcImg_data_stream_V_read;
wire   [7:0] get_grads_opr_U0_dstImg_data_stream_V_din;
wire    get_grads_opr_U0_dstImg_data_stream_V_write;
...
wire   [0:0] start_for_get_grads_opr_U0_din;
wire    start_for_get_grads_opr_U0_full_n;
wire   [0:0] start_for_get_grads_opr_U0_dout;
wire    start_for_get_grads_opr_U0_empty_n;
...
get_grads_opr get_grads_opr_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
start_for_get_grafYi start_for_get_grafYi_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (get_grads_opr_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_proc_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign get_grads_opr_U0_ap_continue = 1'b1;

assign get_grads_opr_U0_ap_start = start_for_get_grads_opr_U0_empty_n;

assign start_for_Mat2AXIvideo_U0_din = 1'b1;

assign start_for_get_grads_opr_U0_din = 1'b1;
