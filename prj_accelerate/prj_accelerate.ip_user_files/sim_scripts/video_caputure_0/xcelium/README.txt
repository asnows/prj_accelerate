...
#
# Generated by export_simulation on Thu Aug 08 15:25:52 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './video_caputure_0.sh' script.

./video_caputure_0.sh -reset_run
...
./video_caputure_0.sh -noclean_files

For more information on the script, please type './video_caputure_0.sh -help'.
