...
#
# Generated by export_simulation on Fri Oct 12 10:53:02 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './fifo_line.sh' script.

./fifo_line.sh -reset_run
...
./fifo_line.sh -noclean_files

For more information on the script, please type './fifo_line.sh -help'.
