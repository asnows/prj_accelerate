...
#
# Generated by export_simulation on Sat Aug 03 08:42:21 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './img_cpy_0.sh' script.

./img_cpy_0.sh -reset_run
...
./img_cpy_0.sh -noclean_files

For more information on the script, please type './img_cpy_0.sh -help'.
