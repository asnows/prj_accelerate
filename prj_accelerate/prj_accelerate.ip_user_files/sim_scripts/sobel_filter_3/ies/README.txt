...
#
# Generated by export_simulation on Thu Aug 01 17:11:03 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './sobel_filter_3.sh' script.

./sobel_filter_3.sh -reset_run
...
./sobel_filter_3.sh -noclean_files

For more information on the script, please type './sobel_filter_3.sh -help'.
