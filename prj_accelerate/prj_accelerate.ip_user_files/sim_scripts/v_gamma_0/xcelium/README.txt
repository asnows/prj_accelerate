...
#
# Generated by export_simulation on Fri Mar 15 14:40:16 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './v_gamma_0.sh' script.

./v_gamma_0.sh -reset_run
...
./v_gamma_0.sh -noclean_files

For more information on the script, please type './v_gamma_0.sh -help'.
