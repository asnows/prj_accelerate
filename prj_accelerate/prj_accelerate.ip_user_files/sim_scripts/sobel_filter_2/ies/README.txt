...
#
# Generated by export_simulation on Mon Dec 03 13:37:38 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './sobel_filter_2.sh' script.

./sobel_filter_2.sh -reset_run
...
./sobel_filter_2.sh -noclean_files

For more information on the script, please type './sobel_filter_2.sh -help'.
