...
#
# Generated by export_simulation on Wed Oct 31 16:26:20 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './line_shift_ram_0.sh' script.

./line_shift_ram_0.sh -reset_run
...
./line_shift_ram_0.sh -noclean_files

For more information on the script, please type './line_shift_ram_0.sh -help'.
