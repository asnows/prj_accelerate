...
(* CORE_GENERATION_INFO="hls_ocr,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=14.028500,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=10,HLS_SYN_DSP=18,HLS_SYN_FF=3585,HLS_SYN_LUT=5225}" *)
...
wire    threshold_filter_U0_ap_done;
wire    threshold_filter_U0_ap_continue;
wire    threshold_filter_U0_ap_idle;
wire    threshold_filter_U0_ap_ready;
wire    threshold_filter_U0_start_out;
wire    threshold_filter_U0_start_write;
wire    threshold_filter_U0_srcImg_data_stream_V_read;
wire   [7:0] threshold_filter_U0_dstImg_data_stream_V_din;
wire    threshold_filter_U0_dstImg_data_stream_V_write;
...
wire   [9:0] srcImg_rows_V_c12_dout;
wire    srcImg_rows_V_c12_empty_n;
wire    srcImg_cols_V_c13_full_n;
wire   [10:0] srcImg_cols_V_c13_dout;
...
wire   [7:0] dilateImg_data_strea_dout;
...
wire   [0:0] start_for_threshold_filter_U0_din;
wire    start_for_threshold_filter_U0_full_n;
wire   [0:0] start_for_threshold_filter_U0_dout;
wire    start_for_threshold_filter_U0_empty_n;
...
AXIvideo2Mat AXIvideo2Mat_U0(
    ...
    .img_rows_V_out_full_n(srcImg_rows_V_c12_full_n),
    .img_rows_V_out_write(AXIvideo2Mat_U0_img_rows_V_out_write),
    .img_cols_V_out_din(AXIvideo2Mat_U0_img_cols_V_out_din),
    .img_cols_V_out_full_n(srcImg_cols_V_c13_full_n),
...
hls_otsu hls_otsu_U0(
    ...
    .srcImg_rows_V_dout(srcImg_rows_V_c12_dout),
    .srcImg_rows_V_empty_n(srcImg_rows_V_c12_empty_n),
    .srcImg_rows_V_read(hls_otsu_U0_srcImg_rows_V_read),
    .srcImg_cols_V_dout(srcImg_cols_V_c13_dout),
    .srcImg_cols_V_empty_n(srcImg_cols_V_c13_empty_n),
...
Dilate Dilate_U0(
    ...
    .start_full_n(start_for_threshold_filter_U0_full_n),
    ...
    .p_dst_data_stream_V_full_n(dilateImg_data_strea_full_n),
    .p_dst_data_stream_V_write(Dilate_U0_p_dst_data_stream_V_write)
);

threshold_filter threshold_filter_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(threshold_filter_U0_ap_start),
    .start_full_n(start_for_Mat2AXIvideo_U0_full_n),
    .ap_done(threshold_filter_U0_ap_done),
    .ap_continue(threshold_filter_U0_ap_continue),
    .ap_idle(threshold_filter_U0_ap_idle),
    .ap_ready(threshold_filter_U0_ap_ready),
    .start_out(threshold_filter_U0_start_out),
    .start_write(threshold_filter_U0_start_write),
    .srcImg_data_stream_V_dout(dilateImg_data_strea_dout),
    .srcImg_data_stream_V_empty_n(dilateImg_data_strea_empty_n),
    .srcImg_data_stream_V_read(threshold_filter_U0_srcImg_data_stream_V_read),
    .dstImg_data_stream_V_din(threshold_filter_U0_dstImg_data_stream_V_din),
    .dstImg_data_stream_V_full_n(dstImg_data_stream_0_full_n),
    .dstImg_data_stream_V_write(threshold_filter_U0_dstImg_data_stream_V_write)
);
...
fifo_w10_d2_A srcImg_rows_V_c12_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIvideo2Mat_U0_img_rows_V_out_din),
    .if_full_n(srcImg_rows_V_c12_full_n),
    .if_write(AXIvideo2Mat_U0_img_rows_V_out_write),
    .if_dout(srcImg_rows_V_c12_dout),
    .if_empty_n(srcImg_rows_V_c12_empty_n),
    .if_read(hls_otsu_U0_srcImg_rows_V_read)
);

fifo_w11_d2_A srcImg_cols_V_c13_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(AXIvideo2Mat_U0_img_cols_V_out_din),
    .if_full_n(srcImg_cols_V_c13_full_n),
    .if_write(AXIvideo2Mat_U0_img_cols_V_out_write),
    .if_dout(srcImg_cols_V_c13_dout),
    .if_empty_n(srcImg_cols_V_c13_empty_n),
...
fifo_w8_d2_A dilateImg_data_strea_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(Dilate_U0_p_dst_data_stream_V_din),
    .if_full_n(dilateImg_data_strea_full_n),
    .if_write(Dilate_U0_p_dst_data_stream_V_write),
    .if_dout(dilateImg_data_strea_dout),
    .if_empty_n(dilateImg_data_strea_empty_n),
    .if_read(threshold_filter_U0_srcImg_data_stream_V_read)
);
...
fifo_w8_d2_A dstImg_data_stream_0_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(threshold_filter_U0_dstImg_data_stream_V_din),
    .if_full_n(dstImg_data_stream_0_full_n),
    .if_write(threshold_filter_U0_dstImg_data_stream_V_write),
...
start_for_threshoncg start_for_threshoncg_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_threshold_filter_U0_din),
    .if_full_n(start_for_threshold_filter_U0_full_n),
    .if_write(Dilate_U0_start_write),
    .if_dout(start_for_threshold_filter_U0_dout),
    .if_empty_n(start_for_threshold_filter_U0_empty_n),
    .if_read(threshold_filter_U0_ap_ready)
);
...
start_for_Mat2AXIocq start_for_Mat2AXIocq_U(
    ...
    .if_write(threshold_filter_U0_start_write),
...
assign ap_idle = (threshold_filter_U0_ap_idle & hls_otsu_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Erode_U0_ap_idle & Dilate_U0_ap_idle & Block_proc_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign start_for_threshold_filter_U0_din = 1'b1;

assign threshold_filter_U0_ap_continue = 1'b1;

assign threshold_filter_U0_ap_start = start_for_threshold_filter_U0_empty_n;
