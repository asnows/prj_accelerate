...
architecture behav of img_cpy is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "img_cpy,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.268000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=645,HLS_SYN_LUT=917}";
    ...
    signal img_cpy_opr_U0_ap_done : STD_LOGIC;
    signal img_cpy_opr_U0_ap_continue : STD_LOGIC;
    signal img_cpy_opr_U0_ap_idle : STD_LOGIC;
    signal img_cpy_opr_U0_ap_ready : STD_LOGIC;
    signal img_cpy_opr_U0_start_out : STD_LOGIC;
    signal img_cpy_opr_U0_start_write : STD_LOGIC;
    signal img_cpy_opr_U0_srcImg_rows_V_read : STD_LOGIC;
    signal img_cpy_opr_U0_srcImg_cols_V_read : STD_LOGIC;
    signal img_cpy_opr_U0_srcImg_data_stream_V_read : STD_LOGIC;
    signal img_cpy_opr_U0_dstImg_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal img_cpy_opr_U0_dstImg_data_stream_V_write : STD_LOGIC;
    ...
    signal Mat2AXIvideo_U0_video_out_TDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal Mat2AXIvideo_U0_video_out_TVALID : STD_LOGIC;
    signal Mat2AXIvideo_U0_video_out_TKEEP : STD_LOGIC_VECTOR (7 downto 0);
    signal Mat2AXIvideo_U0_video_out_TSTRB : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal dstImg_data_stream_0_dout : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal start_for_img_cpy_opr_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_img_cpy_opr_U0_full_n : STD_LOGIC;
    signal start_for_img_cpy_opr_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_img_cpy_opr_U0_empty_n : STD_LOGIC;
    ...
    component start_for_img_cpybkb IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        start_full_n => start_for_img_cpy_opr_U0_full_n,
    ...
    img_cpy_opr_U0 : component img_cpy_opr
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => img_cpy_opr_U0_ap_start,
        start_full_n => start_for_Mat2AXIvideo_U0_full_n,
        ap_done => img_cpy_opr_U0_ap_done,
        ap_continue => img_cpy_opr_U0_ap_continue,
        ap_idle => img_cpy_opr_U0_ap_idle,
        ap_ready => img_cpy_opr_U0_ap_ready,
        start_out => img_cpy_opr_U0_start_out,
        start_write => img_cpy_opr_U0_start_write,
        srcImg_rows_V_dout => srcImg_rows_V_c6_dout,
        srcImg_rows_V_empty_n => srcImg_rows_V_c6_empty_n,
        srcImg_rows_V_read => img_cpy_opr_U0_srcImg_rows_V_read,
        srcImg_cols_V_dout => srcImg_cols_V_c7_dout,
        srcImg_cols_V_empty_n => srcImg_cols_V_c7_empty_n,
        srcImg_cols_V_read => img_cpy_opr_U0_srcImg_cols_V_read,
        srcImg_data_stream_V_dout => srcImg_data_stream_0_dout,
        srcImg_data_stream_V_empty_n => srcImg_data_stream_0_empty_n,
        srcImg_data_stream_V_read => img_cpy_opr_U0_srcImg_data_stream_V_read,
        dstImg_data_stream_V_din => img_cpy_opr_U0_dstImg_data_stream_V_din,
        dstImg_data_stream_V_full_n => dstImg_data_stream_0_full_n,
        dstImg_data_stream_V_write => img_cpy_opr_U0_dstImg_data_stream_V_write);
    ...
    port map (
        ...
        if_read => img_cpy_opr_U0_srcImg_data_stream_V_read);
    ...
    port map (
        ...
        if_read => img_cpy_opr_U0_srcImg_rows_V_read);
    ...
    port map (
        ...
        if_read => img_cpy_opr_U0_srcImg_cols_V_read);

    dstImg_data_stream_0_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => img_cpy_opr_U0_dstImg_data_stream_V_din,
        if_full_n => dstImg_data_stream_0_full_n,
        if_write => img_cpy_opr_U0_dstImg_data_stream_V_write,
        if_dout => dstImg_data_stream_0_dout,
        if_empty_n => dstImg_data_stream_0_empty_n,
        if_read => Mat2AXIvideo_U0_img_data_stream_V_read);

    start_for_img_cpybkb_U : component start_for_img_cpybkb
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => start_for_img_cpy_opr_U0_din,
        if_full_n => start_for_img_cpy_opr_U0_full_n,
        if_write => AXIvideo2Mat_U0_start_write,
        if_dout => start_for_img_cpy_opr_U0_dout,
        if_empty_n => start_for_img_cpy_opr_U0_empty_n,
        if_read => img_cpy_opr_U0_ap_ready);
    ...
    port map (
        ...
        if_write => img_cpy_opr_U0_start_write,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (img_cpy_opr_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Block_proc_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ap_ready <= AXIvideo2Mat_U0_ap_ready;
    ...
    img_cpy_opr_U0_ap_continue <= ap_const_logic_1;
    img_cpy_opr_U0_ap_start <= start_for_img_cpy_opr_U0_empty_n;
    start_for_Mat2AXIvideo_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_img_cpy_opr_U0_din <= (0=>ap_const_logic_1, others=>'-');
    video_in_TREADY <= AXIvideo2Mat_U0_video_in_TREADY;
    video_out_TDATA <= Mat2AXIvideo_U0_video_out_TDATA;
    video_out_TDEST <= Mat2AXIvideo_U0_video_out_TDEST;
    video_out_TID <= Mat2AXIvideo_U0_video_out_TID;
