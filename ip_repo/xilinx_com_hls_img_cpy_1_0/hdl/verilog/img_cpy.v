...
(* CORE_GENERATION_INFO="img_cpy,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.268000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=645,HLS_SYN_LUT=917}" *)
...
wire    img_cpy_opr_U0_ap_done;
wire    img_cpy_opr_U0_ap_continue;
wire    img_cpy_opr_U0_ap_idle;
wire    img_cpy_opr_U0_ap_ready;
wire    img_cpy_opr_U0_start_out;
wire    img_cpy_opr_U0_start_write;
wire    img_cpy_opr_U0_srcImg_rows_V_read;
wire    img_cpy_opr_U0_srcImg_cols_V_read;
wire    img_cpy_opr_U0_srcImg_data_stream_V_read;
wire   [7:0] img_cpy_opr_U0_dstImg_data_stream_V_din;
wire    img_cpy_opr_U0_dstImg_data_stream_V_write;
...
wire   [63:0] Mat2AXIvideo_U0_video_out_TDATA;
wire    Mat2AXIvideo_U0_video_out_TVALID;
wire   [7:0] Mat2AXIvideo_U0_video_out_TKEEP;
wire   [7:0] Mat2AXIvideo_U0_video_out_TSTRB;
...
wire   [9:0] srcImg_rows_V_c6_dout;
wire    srcImg_rows_V_c6_empty_n;
wire    srcImg_cols_V_c7_full_n;
wire   [10:0] srcImg_cols_V_c7_dout;
...
wire   [0:0] start_for_img_cpy_opr_U0_din;
wire    start_for_img_cpy_opr_U0_full_n;
wire   [0:0] start_for_img_cpy_opr_U0_dout;
wire    start_for_img_cpy_opr_U0_empty_n;
...
fifo_w10_d2_A srcImg_rows_V_c6_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A srcImg_cols_V_c7_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_img_cpybkb start_for_img_cpybkb_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign ap_idle = (img_cpy_opr_U0_ap_idle & Mat2AXIvideo_U0_ap_idle & Block_proc_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign img_cpy_opr_U0_ap_continue = 1'b1;

assign img_cpy_opr_U0_ap_start = start_for_img_cpy_opr_U0_empty_n;

assign start_for_Mat2AXIvideo_U0_din = 1'b1;

assign start_for_img_cpy_opr_U0_din = 1'b1;
