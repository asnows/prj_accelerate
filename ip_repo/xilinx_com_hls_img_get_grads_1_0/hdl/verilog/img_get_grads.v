...
(* CORE_GENERATION_INFO="img_get_grads,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.386250,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=33,HLS_SYN_DSP=70,HLS_SYN_FF=8072,HLS_SYN_LUT=9327}" *)
...
wire   [31:0] get_grads_opr_U0_dstImg_data_stream_V_din;
...
start_for_get_gratde start_for_get_gratde_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
