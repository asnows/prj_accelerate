...
entity pown_generic_floadEe_rom is 
    generic(
             dwidth     : integer := 52; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of pown_generic_floadEe_rom is 
...
entity pown_generic_floadEe is
    generic (
...
architecture arch of pown_generic_floadEe is
    component pown_generic_floadEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pown_generic_floadEe_rom_U :  component pown_generic_floadEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
