...
entity pown_generic_floacud_rom is 
    generic(
             dwidth     : integer := 56; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of pown_generic_floacud_rom is 
...
entity pown_generic_floacud is
    generic (
...
architecture arch of pown_generic_floacud is
    component pown_generic_floacud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pown_generic_floacud_rom_U :  component pown_generic_floacud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
