...
entity pown_generic_floabkb_rom is 
    generic(
             dwidth     : integer := 6; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of pown_generic_floabkb_rom is 
...
entity pown_generic_floabkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of pown_generic_floabkb is
    component pown_generic_floabkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pown_generic_floabkb_rom_U :  component pown_generic_floabkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
