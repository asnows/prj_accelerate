...
architecture behav of sobel_filter is 
    ...
    "sobel_filter,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=10.049000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=6,HLS_SYN_DSP=4,HLS_SYN_FF=1855,HLS_SYN_LUT=4662}";
    ...
    signal Mat2AXIvideo_U0_video_out_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal Mat2AXIvideo_U0_video_out_TVALID : STD_LOGIC;
    signal Mat2AXIvideo_U0_video_out_TKEEP : STD_LOGIC_VECTOR (0 downto 0);
    signal Mat2AXIvideo_U0_video_out_TSTRB : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal img_0_rows_V_c8_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal img_0_rows_V_c8_empty_n : STD_LOGIC;
    signal img_0_cols_V_c9_full_n : STD_LOGIC;
    signal img_0_cols_V_c9_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component start_for_Sobel_1hbi IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    img_0_rows_V_c8_U : component fifo_w10_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V_c9_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1hbi_U : component start_for_Sobel_1hbi
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Sobel_U0_ap_idle and Sobel_1_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and Block_proc_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ap_ready <= AXIvideo2Mat_U0_ap_ready;
